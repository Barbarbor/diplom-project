  ...
  en: {
    translation: {
      ...
      profile: {
        ...
        saveError: "Failed to save profile: {{message}}",
      },
      contacts: {
        title: "Contacts",
        section1: {
      ...
      survey: {
        ...
        stats: {
          ...
          csv: {
            ...
            startedInterviews: "Started Interviews",
            completedInterviews: "Completed Interviews",
            averageCompletionTime: "Average Completion Time",
            question: "Question",
            type: "Type",
            singleChoiceOption: "{{label}} ({{count}} times, {{percentage}}%)",
            multiChoiceOption: "{{label}} ({{count}} times, {{percentage}}%)",
            consentYes: "Yes ({{count}} times, {{percentage}}%)",
            consentNo: "No ({{count}} times, {{percentage}}%)",
            ratingAverage: "Average Rating",
            ratingStar: "{{star}} Star ({{count}} times, {{percentage}}%)",
            textAnswer: "{{answer}} ({{count}} times)",
            dateAnswer: "{{date}} ({{count}} times)",
            numberAnswer: "{{number}} ({{count}} times)",
            emailAnswer: "{{email}}",
          },
        },
        question: {
  ...
  ru: {
    translation: {
      ...
      profile: {
        ...
        saveError: "Ошибка при сохранении профиля: {{message}}",
      },
      contacts: {
        title: "Контакты",
        section1: {
      ...
      survey: {
        ...
        stats: {
          ...
          csv: {
            ...
            startedInterviews: "Начато интервью",
            completedInterviews: "Завершено интервью",
            averageCompletionTime: "Среднее время прохождения анкеты",
            question: "Вопрос",
            type: "Тип",
            singleChoiceOption: "{{label}} ({{count}} раз, {{percentage}}%)",
            multiChoiceOption: "{{label}} ({{count}} раз, {{percentage}}%)",
            consentYes: "Согласны ({{count}} раз, {{percentage}}%)",
            consentNo: "Не согласны ({{count}} раз, {{percentage}}%)",
            ratingAverage: "Средний рейтинг",
            ratingStar: "{{star}} звезда ({{count}} раз, {{percentage}}%)",
            textAnswer: "{{answer}} ({{count}} раз)",
            dateAnswer: "{{date}} ({{count}} раз)",
            numberAnswer: "{{number}} ({{count}} раз)",
            emailAnswer: "{{email}}",
          },
        },
        question: {
